...
/**
 * 🍏 Implementación iOS del [ApiClient] multiplataforma.
 *
 * Esta clase proporciona la funcionalidad de cliente API para la plataforma iOS,
...
actual class ApiClient actual constructor() {
    ...
    actual suspend fun login(pLogin: SesionRequest): SesionResponse {
        return try {
            val url = AppConfig.getApiLoginUrl(false) // isAndroid = false
